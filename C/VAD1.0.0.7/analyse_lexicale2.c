...
enum charactere
{
    SIMPLE_GUILLEMET_ANGLAIS,
    DOUBLE_GUILLEMET_ANGLAIS,
    CROCHET,
    ACOLADE,
    PARENTHESE
};

bool valeurTypesBool = false;
bool variableTypeBool = true;
bool operateursBool = true;
bool affectationBool = true;
bool charactereBool = true;
...
bool chaine(const char *variable)
{
...
void MAJBool(int lexique)
{

    if (lexique == 1)
    {
        bool valeurTypesBool = false;
        bool variableTypeBool = false;
        bool operateursBool = true;
        bool affectationBool = false;
        bool charactereBool = false;
    }
    else if (lexique == 2)
    {
        bool valeurTypesBool = false;
